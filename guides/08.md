...
```mermaid
flowchart LR
    Input["🔍 検索ボックス<br/>「ラーメン」と入力"] --> Search["🎛 コントローラー<br/>キーワードで絞り込む"]
    Search --> Result["📰 タイトルか本文に<br/>「ラーメン」を含む記事だけ"]
```
...
```mermaid
flowchart TB
    NG["❌ いきなり完璧なタグ機能を<br/>作ろうとする"]
    OK1["✅ まず tags テーブルだけ作る"] --> OK2["✅ php artisan migrate して<br/>動くことを確認"] --> OK3["✅ そこから少しずつ足す"]
```
