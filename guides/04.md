...
flowchart TB
    ...
    Root --> Res["📁 resources"]
    Root --> Rou["📁 routes"]
    Root --> Env["⚙️ .env<br/>設定ファイル"]

    App --> Ctl["📁 Http/Controllers<br/>🎛 処理の司令塔"]
    App --> Mdl["📁 Models<br/>🗃 データを表すクラス"]
    DB --> Mig["📁 migrations<br/>📐 表の設計図"]
    DB --> Sql["🗄 database.sqlite<br/>記事が保存されるファイル"]
    Res --> Css["🎨 css/app.css<br/>05で使います"]
    Res --> Vie["📁 views<br/>🖼 画面のHTML・05で使います"]
    Rou --> Web["🗺 web.php<br/>URLの振り分け表"]
```
